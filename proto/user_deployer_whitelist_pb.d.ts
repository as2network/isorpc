...
export class Tier extends jspb.Message {
  ...
  hasFee(): boolean;
  clearFee(): void;
  getFee(): proto_as2ng_pb.BigUInt | undefined;
  setFee(value?: proto_as2ng_pb.BigUInt): void;
...
export namespace Tier {
  export type AsObject = {
    tierId: TierID,
    fee?: proto_as2ng_pb.BigUInt.AsObject,
    name: string,
  }
}
...
export class DeployerContract extends jspb.Message {
  ...
  getContractAddress(): proto_as2ng_pb.Address | undefined;
  setContractAddress(value?: proto_as2ng_pb.Address): void;
...
export namespace DeployerContract {
  export type AsObject = {
    contractAddress?: proto_as2ng_pb.Address.AsObject,
  }
}
...
export class WhitelistUserDeployerRequest extends jspb.Message {
  ...
  getDeployerAddr(): proto_as2ng_pb.Address | undefined;
  setDeployerAddr(value?: proto_as2ng_pb.Address): void;
...
export namespace WhitelistUserDeployerRequest {
  export type AsObject = {
    deployerAddr?: proto_as2ng_pb.Address.AsObject,
    tierId: TierID,
  }
}
...
export class UserState extends jspb.Message {
  hasUserAddr(): boolean;
  clearUserAddr(): void;
  getUserAddr(): proto_as2ng_pb.Address | undefined;
  setUserAddr(value?: proto_as2ng_pb.Address): void;

  clearDeployersList(): void;
  getDeployersList(): Array<proto_as2ng_pb.Address>;
  setDeployersList(value: Array<proto_as2ng_pb.Address>): void;
  addDeployers(value?: proto_as2ng_pb.Address, index?: number): proto_as2ng_pb.Address;
...
export namespace UserState {
  export type AsObject = {
    userAddr?: proto_as2ng_pb.Address.AsObject,
    deployersList: Array<proto_as2ng_pb.Address.AsObject>,
  }
}
