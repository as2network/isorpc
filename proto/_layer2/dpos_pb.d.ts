...
export class Vote extends jspb.Message {
  ...
  getVoterAddress(): proto_as2ng_pb.Address | undefined;
  setVoterAddress(value?: proto_as2ng_pb.Address): void;
...
export namespace Vote {
  export type AsObject = {
    voterAddress?: proto_as2ng_pb.Address.AsObject,
...
export class ProxyVoteRequest extends jspb.Message {
  ...
  getProxyAddress(): proto_as2ng_pb.Address | undefined;
  setProxyAddress(value?: proto_as2ng_pb.Address): void;
...
export namespace ProxyVoteRequest {
  export type AsObject = {
    proxyAddress?: proto_as2ng_pb.Address.AsObject,
  }
}
