...
export class EventData extends jspb.Message {
  ...
  hasCaller(): boolean;
  clearCaller(): void;
  getCaller(): proto_as2ng_pb.Address | undefined;
  setCaller(value?: proto_as2ng_pb.Address): void;
...
export namespace EventData {
  export type AsObject = {
    ...
    caller?: proto_as2ng_pb.Address.AsObject,
...
export class EvmTxReceipt extends jspb.Message {
  ...
  getLogsBas2ng(): Uint8Array | string;
  getLogsBas2ng_asU8(): Uint8Array;
  getLogsBas2ng_asB64(): string;
  setLogsBas2ng(value: Uint8Array | string): void;
