...
export class TransferGatewayState extends jspb.Message {
  hasOwner(): boolean;
  clearOwner(): void;
  getOwner(): proto_as2ng_pb.Address | undefined;
  setOwner(value?: proto_as2ng_pb.Address): void;
  ...
  getTokenWithdrawersList(): Array<proto_as2ng_pb.Address>;
  setTokenWithdrawersList(value: Array<proto_as2ng_pb.Address>): void;
  addTokenWithdrawers(value?: proto_as2ng_pb.Address, index?: number): proto_as2ng_pb.Address;

  hasTransferFee(): boolean;
  clearTransferFee(): void;
  getTransferFee(): proto_as2ng_pb.BigUInt | undefined;
  setTransferFee(value?: proto_as2ng_pb.BigUInt): void;

  hasMainnetGatewayAddress(): boolean;
  clearMainnetGatewayAddress(): void;
  getMainnetGatewayAddress(): proto_as2ng_pb.Address | undefined;
  setMainnetGatewayAddress(value?: proto_as2ng_pb.Address): void;

  hasMainnetHotWalletAddress(): boolean;
  clearMainnetHotWalletAddress(): void;
  getMainnetHotWalletAddress(): proto_as2ng_pb.Address | undefined;
  setMainnetHotWalletAddress(value?: proto_as2ng_pb.Address): void;

  hasMaxTotalDailyWithdrawalAmount(): boolean;
  clearMaxTotalDailyWithdrawalAmount(): void;
  getMaxTotalDailyWithdrawalAmount(): proto_as2ng_pb.BigUInt | undefined;
  setMaxTotalDailyWithdrawalAmount(value?: proto_as2ng_pb.BigUInt): void;

  hasMaxPerAccountDailyWithdrawalAmount(): boolean;
  clearMaxPerAccountDailyWithdrawalAmount(): void;
  getMaxPerAccountDailyWithdrawalAmount(): proto_as2ng_pb.BigUInt | undefined;
  setMaxPerAccountDailyWithdrawalAmount(value?: proto_as2ng_pb.BigUInt): void;
  ...
  getTotalWithdrawalAmount(): proto_as2ng_pb.BigUInt | undefined;
  setTotalWithdrawalAmount(value?: proto_as2ng_pb.BigUInt): void;
...
export namespace TransferGatewayState {
  export type AsObject = {
    owner?: proto_as2ng_pb.Address.AsObject,
    lastMainnetBlockNum: number,
    nextContractMappingId: number,
    tokenWithdrawersList: Array<proto_as2ng_pb.Address.AsObject>,
    transferFee?: proto_as2ng_pb.BigUInt.AsObject,
    mainnetGatewayAddress?: proto_as2ng_pb.Address.AsObject,
    mainnetHotWalletAddress?: proto_as2ng_pb.Address.AsObject,
    maxTotalDailyWithdrawalAmount?: proto_as2ng_pb.BigUInt.AsObject,
    maxPerAccountDailyWithdrawalAmount?: proto_as2ng_pb.BigUInt.AsObject,
    lastWithdrawalLimitResetTime: number,
    totalWithdrawalAmount?: proto_as2ng_pb.BigUInt.AsObject,
  }
}
...
export class TransferGatewayWithdrawalReceipt extends jspb.Message {
  ...
  getTokenOwner(): proto_as2ng_pb.Address | undefined;
  setTokenOwner(value?: proto_as2ng_pb.Address): void;

  hasTokenContract(): boolean;
  clearTokenContract(): void;
  getTokenContract(): proto_as2ng_pb.Address | undefined;
  setTokenContract(value?: proto_as2ng_pb.Address): void;
  ...
  hasTokenId(): boolean;
  clearTokenId(): void;
  getTokenId(): proto_as2ng_pb.BigUInt | undefined;
  setTokenId(value?: proto_as2ng_pb.BigUInt): void;

  hasTokenAmount(): boolean;
  clearTokenAmount(): void;
  getTokenAmount(): proto_as2ng_pb.BigUInt | undefined;
  setTokenAmount(value?: proto_as2ng_pb.BigUInt): void;
...
export namespace TransferGatewayWithdrawalReceipt {
  export type AsObject = {
    tokenOwner?: proto_as2ng_pb.Address.AsObject,
    tokenContract?: proto_as2ng_pb.Address.AsObject,
    tokenKind: TransferGatewayTokenKind,
    tokenId?: proto_as2ng_pb.BigUInt.AsObject,
    tokenAmount?: proto_as2ng_pb.BigUInt.AsObject,
...
export class TransferGatewayContractMappingConfirmed extends jspb.Message {
  ...
  getForeignContract(): proto_as2ng_pb.Address | undefined;
  setForeignContract(value?: proto_as2ng_pb.Address): void;

  hasLocalContract(): boolean;
  clearLocalContract(): void;
  getLocalContract(): proto_as2ng_pb.Address | undefined;
  setLocalContract(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayContractMappingConfirmed {
  export type AsObject = {
    foreignContract?: proto_as2ng_pb.Address.AsObject,
    localContract?: proto_as2ng_pb.Address.AsObject,
  }
}
...
export class TransferGatewayReclaimDepositorTokensRequest extends jspb.Message {
  ...
  getDepositorsList(): Array<proto_as2ng_pb.Address>;
  setDepositorsList(value: Array<proto_as2ng_pb.Address>): void;
  addDepositors(value?: proto_as2ng_pb.Address, index?: number): proto_as2ng_pb.Address;
...
export namespace TransferGatewayReclaimDepositorTokensRequest {
  export type AsObject = {
    depositorsList: Array<proto_as2ng_pb.Address.AsObject>,
  }
}
...
export class TransferGatewayWithdrawTokenRequest extends jspb.Message {
  ...
  clearRecipient(): void;
  getRecipient(): proto_as2ng_pb.Address | undefined;
  setRecipient(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayWithdrawTokenRequest {
  export type AsObject = {
    ...
    tokenId?: proto_as2ng_pb.BigUInt.AsObject,
    tokenAmount?: proto_as2ng_pb.BigUInt.AsObject,
    recipient?: proto_as2ng_pb.Address.AsObject,
  }
}
...
export class TransferGatewayWithdrawETHRequest extends jspb.Message {
  ...
  getMainnetGateway(): proto_as2ng_pb.Address | undefined;
  setMainnetGateway(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayWithdrawETHRequest {
  export type AsObject = {
    ...
    mainnetGateway?: proto_as2ng_pb.Address.AsObject,
    recipient?: proto_as2ng_pb.Address.AsObject,
  }
}

export class TransferGatewayWithdrawAS2ngCoinRequest extends jspb.Message {
  hasAmount(): boolean;
  clearAmount(): void;
  getAmount(): proto_as2ng_pb.BigUInt | undefined;
  setAmount(value?: proto_as2ng_pb.BigUInt): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TransferGatewayWithdrawAS2ngCoinRequest.AsObject;
  static toObject(includeInstance: boolean, msg: TransferGatewayWithdrawAS2ngCoinRequest): TransferGatewayWithdrawAS2ngCoinRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: TransferGatewayWithdrawAS2ngCoinRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TransferGatewayWithdrawAS2ngCoinRequest;
  static deserializeBinaryFromReader(message: TransferGatewayWithdrawAS2ngCoinRequest, reader: jspb.BinaryReader): TransferGatewayWithdrawAS2ngCoinRequest;
}

export namespace TransferGatewayWithdrawAS2ngCoinRequest {
  export type AsObject = {
    amount?: proto_as2ng_pb.BigUInt.AsObject,
    tokenContract?: proto_as2ng_pb.Address.AsObject,
    recipient?: proto_as2ng_pb.Address.AsObject,
...
export class TransferGatewayGetContractMappingRequest extends jspb.Message {
  hasFrom(): boolean;
  clearFrom(): void;
  getFrom(): proto_as2ng_pb.Address | undefined;
  setFrom(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayGetContractMappingRequest {
  export type AsObject = {
    from?: proto_as2ng_pb.Address.AsObject,
  }
}
...
export class TransferGatewayGetContractMappingResponse extends jspb.Message {
  ...
  getMappedAddress(): proto_as2ng_pb.Address | undefined;
  setMappedAddress(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayGetContractMappingResponse {
  export type AsObject = {
    mappedAddress?: proto_as2ng_pb.Address.AsObject,
    isPending: boolean,
    found: boolean,
  }
}
...
export class TransferGatewayContractAddressMapping extends jspb.Message {
  ...
  hasTo(): boolean;
  clearTo(): void;
  getTo(): proto_as2ng_pb.Address | undefined;
  setTo(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayContractAddressMapping {
  export type AsObject = {
    from?: proto_as2ng_pb.Address.AsObject,
    to?: proto_as2ng_pb.Address.AsObject,
  }
}
...
export class TransferGatewayPendingContractMapping extends jspb.Message {
  ...
  getForeignContractCreator(): proto_as2ng_pb.Address | undefined;
  setForeignContractCreator(value?: proto_as2ng_pb.Address): void;
...
export namespace TransferGatewayPendingContractMapping {
  export type AsObject = {
    ...
    foreignContract?: proto_as2ng_pb.Address.AsObject,
    localContract?: proto_as2ng_pb.Address.AsObject,
    foreignContractCreator?: proto_as2ng_pb.Address.AsObject,
    foreignContractTxHash: Uint8Array | string,
  }
}
